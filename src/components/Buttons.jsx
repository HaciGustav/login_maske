...
export const LoginBtn = () => {
    ...
    return <Button onClick={() => navigate('/')}>Ausloggen</Button>;
};
export const RegisterBtn = () => {
    return <Button>Register</Button>;
};

export const ThemeToggle = ({ darkMode, handleDarkModeSwitch }) => {
